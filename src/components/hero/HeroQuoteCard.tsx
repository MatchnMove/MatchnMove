...
export function HeroQuoteCard() {
  ...
  return (
    <form
      onSubmit={submit}
      className="relative z-20 w-full overflow-visible rounded-[22px] border border-white/10 bg-[linear-gradient(145deg,#101b34_0%,#172857_64%,#1f3f86_100%)] p-3.5 text-left text-white shadow-[0_22px_54px_-38px_rgba(15,23,42,0.85)] sm:p-4"
    >
      <p className="max-w-[35rem] text-[0.86rem] leading-[1.5] text-slate-200 sm:text-[0.92rem]">
        Tell us about your move once, review transparent options, and choose the best mover for your timeline.
      </p>

      <h2 className="mt-2.5 text-[1.18rem] font-black leading-tight tracking-[-0.03em] text-white sm:text-[1.36rem]">
      ...
      <div className="mt-3 grid gap-2.5 sm:grid-cols-2">
        <AddressAutocomplete
          ...
          error={errors.from}
          labelClassName="mb-1 block text-[0.86rem] font-semibold text-slate-100"
