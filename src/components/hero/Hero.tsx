...
export function Hero() {
  return (
    <section className="relative -mb-px overflow-hidden bg-white">
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-start px-4 pb-3 pt-8 text-left sm:px-6 sm:pt-10 xl:pt-[clamp(1.5rem,3.5vh,2.75rem)]">
        ...
        <div className="relative z-20 mt-5 w-full max-w-[640px] sm:mt-6">
          <HeroQuoteCard />
        </div>
      </div>

      <div className="pointer-events-none relative z-10 -mb-px mt-2 sm:mt-1">
        <RiveHeroAnimation />
      </div>
    </section>
  );
